...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) === 0) {
        $query = "SELECT * FROM smanagers WHERE Memail = '$email'";
        $result = mysqli_query($conn, $query);


        if (mysqli_num_rows($result) > 0) {
            array_push($errors, "Email is already associated with an existing account.");
        }
    }
    ...
    if (count($errors) > 0) {
        ...
        $message = "Dear $name,<br><br>
                        Thank you for registering with us. Your verification code is: <div><span style='font-size: 20px; font-weight: bold;'>$code</span></div><br>
        ...
        $mail->Body = $message;
        //DISPLAY HERE A LOADING BAR WHILE WAITING MAIL TO SEND
...
<body>
    < <div class="header-container">
        ...
        <form id="registrationForm" action="sign_up.php" method="post">
